...
for i in range (100):
       ...
       if com=="4":
                ...
                os.system("cd /data/data/com.termux/files/home && rm -rf AmlikeScanner")
                os.system("cd /data/data/com.termux/files/home && git clone https://github.com/Amlike-Tz/AmlikeScanner.git")
                os.system("cd /data/data/com.termux/files/home && cd AmlikeScanner && cd AmlikeScanner")
                os.system(yellow+"\t UPGRADING COMPLETED NOW THE TOOL IS UP TO DATE.ENJOY")
                os.system("YOUR TOOOL IS UP TO DATE!! RUN IT FROM YOUR TERMINAL")
                time.sleep(2) 
                os.system("clear")
